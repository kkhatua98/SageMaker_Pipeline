...
subprocess.run(["cp", build_parameters["scoring_code_loaction"], "tmp_targz"])
subprocess.run(["tar", "-czvf", "inference.tar.gz", "-C", "tmp_targz", build_parameters['scoring_code_loaction'].split('/')[-1]])
